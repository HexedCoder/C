...
START_TEST(test_valid_stack_operation) {
...
START_TEST(test_valid_queue_operation) {
    const char *valid_string = "THIS IS A VALID STRING";
    size_t len = strlen(valid_string);
...
START_TEST(test_valid_extract_back_operation) {
    const char *valid_string = "THIS IS A VALID STRING";
    size_t len = strlen(valid_string);
...
START_TEST(test_valid_find_operation) {
    const char *valid_string = "THIS IS A VALID STRING";
    size_t len = strlen(valid_string);
    size_t search_idx = 6;
...
START_TEST(test_invalid_stack_operation) {
    llist_t *stack = llist_create();
    node_t *curr = (node_t *) llist_pop(stack);
...
START_TEST(test_invalid_queue_operation) {
    llist_t *stack = llist_create();
...
START_TEST(test_invalid_extract_back_operation) {
    llist_t *stack = llist_create();
...
START_TEST(test_invalid_find_operation) {
    const char *valid_string = "THIS IS A VALID STRING";
    size_t len = strlen(valid_string);
    char search_char = 'Z';
